...
export const metadata: Metadata = {
    title: 'Contact Us | EduPortal – School Management System',
    description:
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: 'Contact EduPortal – School Management System Support',
            },
        ],
    },
    twitter: {
    ...
    return (
        <>
            ...
            <ContactHero
                ...
                subtitle="Whether you're exploring EduPortal for the first time, need onboarding assistance, or require technical support — our dedicated education specialists are ready to help you transform school operations."
                badges={[
            ...
            <ContactInfo
                ...
                channels={[
                    ...
                    },
                    {
                        icon: Mail,
                        label: 'Email Us',
                        value: 'support@edu-portal.io',
                        description: 'We respond within 2 business hours',
                        href: 'mailto:support@edu-portal.io',
                    },
                    {
                        icon: MessageSquare,
                        label: 'Live Chat',
                    ...
                    },
                    {
                        ...
                        description: 'See EduPortal in action with your data',
            ...
            <Departments
                ...
                departments={[
                    ...
                    },
                    {
                        ...
                        email: 'onboarding@edu-portal.io',
                        availability: 'Mon–Fri, 8 AM – 6 PM EST',
                    ...
                    },
                    {
                        ...
                        email: 'curriculum@edu-portal.io',
            ...
            <Offices
                ...
                subtitle="EduPortal serves schools across the globe from our regional offices. Drop by for a face-to-face conversation or schedule an on-site demo."
                offices={[
                    {
                        icon: Building2,
                        city: 'Austin',
            ...
            <ContactFAQ
                ...
                items={[
                    ...
                    },
                    {
                        ...
                        answer: 'Absolutely! We offer free 30-minute demo sessions where our education specialists walk you through the entire EduPortal platform using sample school data. You can book a session directly from our Demo page or by contacting sales@edu-portal.io.',
                    },
                    {
                    ...
                    },
                    {
                        ...
                        answer: 'You can report technical issues via email at tech@edu-portal.io, through our live chat, or directly from the Help widget in your EduPortal dashboard. Please include screenshots, the affected module (e.g., Attendance, Fees), and steps to reproduce the issue for the fastest resolution.',
                    },
                    {
                    ...
                    },
                    {
                        ...
                        answer: 'For all billing inquiries — including plan upgrades, invoice disputes, payment method updates, and refund requests — please contact billing@edu-portal.io or call our Billing & Accounts department during business hours (Mon–Fri, 9 AM – 5 PM EST).',
                    },
                    {
                        question: 'Do you have a partner or reseller program?',
                        answer: 'Yes, we partner with EdTech resellers, system integrators, and education consultants worldwide. Our partner program includes white-label options, revenue sharing, co-marketing support, and dedicated partner training. Reach out to partners@edu-portal.io to learn more.',
                    },
                ]}
            />
            ...
            <SocialMedia
                ...
                subtitle="Follow EduPortal for product updates, education insights, webinar announcements, and tips to get the most out of your school management platform."
                platforms={[
                    {
                        icon: Facebook,
                        name: 'Facebook',
            ...
            <ContactCTA
                ...
                title="Start Your EduPortal Journey Today"
